...
namespace coen79_lab2 {
    ...
    class rand_gen // Random generator class
    {
	public:
		rand_gen(int seed = 1, int multiplier = 1, int increment = 1, int modulus = 1); // Constructor
		void set_seed(int newSeed); // To set a new seed value
		int next(); // To find next number in sequence
		void print_info(); // To print the private variables
	private: // All of these values are given in main.cpp file
		int seed;
		int multiplier;
		int increment;
		int modulus;       
