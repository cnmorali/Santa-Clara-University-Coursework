...
def dijkstra(aGraph, start):
	...
	for v in aGraph:
		if not v.visited:
			heapq.heappush(unvisited_queue,(v.get_distance(), id(v),v))
...
if __name__ == '__main__':
    ...
    #nx.draw_networkx_edge_labels(G,pos,width=6, alpha = 0.4)
    #nx.draw_networkx_edges(G,pos,edgelist=SPT_edges,width=6,alpha=0.5,edge_color='b',style='dashed')
